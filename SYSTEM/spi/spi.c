...
void SPI3_Init(void)
{
	...
	RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA |	RCC_APB2Periph_GPIOB | RCC_APB2Periph_AFIO, ENABLE );//PORTB时钟使能 
...
//		cmd_analyze.spi3_rec_buf_index %= CMD_BUF_LEN;
		cmd_analyze.spi3_rec_buf[cmd_analyze.spi3_rec_buf_index++] = SPI_I2S_ReceiveData(SPI3);
		while(SPI_I2S_GetFlagStatus(SPI3, SPI_I2S_FLAG_TXE) == RESET);
		SPI_I2S_SendData(SPI3, temp++);
		LED0_NOT;
		cmd_analyze.spi3_recv_time_out = SPI3_RECV_TIMEOUT;
		/* 清除接收中断 */
